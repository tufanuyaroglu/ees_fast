Feature: Gonderim tipi Kagit ve Istisna tipinde e-Arsiv faturasi olusturulmasi

  Scenario Outline: Gonderim tipi Kagit ve Istisna tipinde e-Arsiv faturasi olusturulmasi
    * Giriş yapılır

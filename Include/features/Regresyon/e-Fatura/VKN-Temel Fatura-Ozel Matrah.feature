Feature: VKNo ile Temel Fatura senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi

  Scenario Outline: VKNo ile Temel Fatura senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi
    * Giriş yapılır

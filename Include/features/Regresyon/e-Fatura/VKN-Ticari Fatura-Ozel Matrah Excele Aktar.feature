Feature: VKNo ile Ticari Fatura senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi

  Scenario Outline: VKNo ile Ticari Fatura senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi
    * Giriş yapılır
    ...
    * Tip alanından Özel Matrah seçilir

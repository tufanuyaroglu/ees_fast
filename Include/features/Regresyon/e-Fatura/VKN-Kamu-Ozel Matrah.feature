Feature: VKNo ile Kamu senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi

  Scenario Outline: VKNo ile Kamu senaryosunda ve Ozel Matrah tipinde fatura olusturulmasi ve Excele aktarilmasi
    * Giriş yapılır
